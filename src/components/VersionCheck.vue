...
import {driverPreVOD, firmwareSupportsMix2, isWindowsWithDevice, isDeviceMini, versionEqualTo, versionNewerOrEqualTo} from "@/util/util";
...
export default {
  ...
  methods: {
    ...
    incompatibleDriver() {
      return driverPreVOD() && firmwareSupportsMix2() && isWindowsWithDevice();
    },
